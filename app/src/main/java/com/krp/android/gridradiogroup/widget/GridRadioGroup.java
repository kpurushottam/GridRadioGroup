...
public class GridRadioGroup extends GridLayout {
    ...
    public GridRadioGroup(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(
                attrs, R.styleable.GridRadioGroup, 0, 0);

        int value = attributes.getResourceId(R.styleable.GridRadioGroup_checkedButton, View.NO_ID);
        if (value != View.NO_ID) {
            mCheckedId = value;
        }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(GridRadioGroup group, @IdRes int checkedId);
    }
